...
public class CertificateSetRequestFieldsTest {
  {
    it("should be invalid if no field is set", () -> {
      ...
      Set<ConstraintViolation<CertificateSetRequestFields>> constraintViolations = validate(certificateSetRequestFields);

      assertThat(constraintViolations, contains(hasViolationWithMessage("error.missing_certificate_credentials")));
    });
