    ...
    describe("when deserializing and validating", () -> {
      ...
      describe("when password parameters are omitted", () -> {
        it("it uses default parameters", () -> {
          ...
          PasswordGenerationParameters defaultParameters = passwordGenerationRequest
              .getGenerationParameters();
          assertThat(defaultParameters.getLength(),
              equalTo(PassayStringSecretGenerator.DEFAULT_LENGTH));
