...
public class SecurityConfigurationTest {
  ...
  private static final String EXPIRED_JWT = "eyJhbGciOiJIUzI1NiIsImtpZCI6ImxlZ2FjeS10b2tlbi1rZXkiLCJ0eXAiOiJKV1QifQ..URLLvIo5BVzCfcBBEgZpnTje6iY3F2ygE7CpC5u480g";
    ...
    ResourceServerTokenServices tokenServices() {
      return new ResourceServerTokenServices() {
        ...
        public OAuth2Authentication loadAuthentication(String accessToken) throws AuthenticationException, InvalidTokenException {
          return jwtAccessTokenConverter.extractAuthentication(new HashMap<>());
        }

        @Override
        public OAuth2AccessToken readAccessToken(String accessToken) {
          return jwtAccessTokenConverter.extractAccessToken(accessToken, new HashMap<>());
        }
      };
    }
  }
