...
public class PermissionsEndpointTest {
  ...
  public void DELETE_whenTheActorIsDeletingOwnPermissions_returnsBadRequest() throws Exception {
    ...
    auditingHelper.verifyAuditing(
        ...
        400,
        newArrayList(
            new EventAuditRecordParameters(ACL_DELETE, credentialName, WRITE_ACL, UAA_OAUTH2_PASSWORD_GRANT_ACTOR_ID),
            new EventAuditRecordParameters(ACL_DELETE, credentialName, WRITE, UAA_OAUTH2_PASSWORD_GRANT_ACTOR_ID),
            new EventAuditRecordParameters(ACL_DELETE, credentialName, READ_ACL, UAA_OAUTH2_PASSWORD_GRANT_ACTOR_ID),
            new EventAuditRecordParameters(ACL_DELETE, credentialName, READ, UAA_OAUTH2_PASSWORD_GRANT_ACTOR_ID),
            new EventAuditRecordParameters(ACL_DELETE, credentialName, DELETE, UAA_OAUTH2_PASSWORD_GRANT_ACTOR_ID)
        )
    );
  }
  ...
  public void POST_whenTheUserUpdatesHisOwnPermissions_returnsBadRequest() throws Exception {
    ...
    auditingHelper.verifyAuditing(
        ...
        400,
        newArrayList(
            new EventAuditRecordParameters(ACL_UPDATE, credentialName, READ, UAA_OAUTH2_PASSWORD_GRANT_ACTOR_ID),
            new EventAuditRecordParameters(ACL_UPDATE, credentialName, WRITE, UAA_OAUTH2_PASSWORD_GRANT_ACTOR_ID),
            new EventAuditRecordParameters(ACL_UPDATE, credentialName, DELETE, "isobel")
        )
    );
  }
