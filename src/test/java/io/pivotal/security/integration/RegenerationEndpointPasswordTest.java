...
public class RegenerationEndpointPasswordTest {
  ...
  public static final String API_V1_DATA_ENDPOINT = "/api/v1/data";
  public static final String API_V1_REGENERATE_ENDPOINT = "/api/v1/regenerate";
  @Autowired
  ...
  public void passwordRegeneration_withDefaultParameters_shouldRegeneratePassword() throws Exception {
    ...
    String originalPassword = (new JSONObject(generatePasswordResult)).getString("value");
