...
public class TestConstants {
  ...
  public static String RSA_PUBLIC_KEY_4096 = "-----BEGIN PUBLIC KEY-----\n" +
    ...
    "-----END PUBLIC KEY-----";
  public static String PRIVATE_KEY_4096 = "-----BEGIN RSA PRIVATE KEY-----\n" +
