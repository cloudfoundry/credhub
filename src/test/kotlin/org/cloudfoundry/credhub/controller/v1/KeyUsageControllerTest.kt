...
class KeyUsageControllerTest {
    ...
    fun `GET key usages gets key distribution across active, inactive, and unknown encryption keys`() {
        ...
        keySet.add(EncryptionKey(mock(InternalEncryptionService::class.java), activeKey, mock(Key::class.java), "key-name"))
        keySet.add(EncryptionKey(mock(InternalEncryptionService::class.java), knownKey, mock(Key::class.java), "key-name"))
