...
class OAuth2AuthenticationExceptionHandler
    @Autowired
    internal constructor(
        ...
        private fun removeTokenFromMessage(
            message: String,
            token: String?,
        ): String = message.replace(": $token", "")
    }

class InvalidUAACertificateException(
    msg: String?,
    t: Throwable?,
) : OAuth2Exception(msg, t) {
    override fun getOAuth2ErrorCode(): String? = "server_error"

    override fun getHttpErrorCode(): Int = 500
}
