...
class TestConstants {
    ...
    companion object {
        ...
        const val INVALID_PRIVATE_KEY_WITH_HEADERS: String = "-----BEGIN RSA PRIVATE KEY----- fake\n" +
        ...
        const val SSH_PUBLIC_KEY_4096: String = ("ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAACAQDs8lQIdJ+tnc9jufX9wLzCPVS1utoTJ" +
        ...
        const val SSH_PUBLIC_KEY_4096_WITH_COMMENT: String = ("ssh-rsa AAAAB3NzaC1yc2EAAAADAQABAAACAQDs8lQIdJ+tnc9jufX9wLzCPVS1utoTJ" +
                "wzQO2NS5F07OEWXnR94XtYY3KtBLu10LHjZzH5maxdWYkyb4GgYSwV+6ln+Txn7" +
                "9LQT8gStbK+mJBFWnGplHNU+loHdHkKckOVihBgDfjsW58s46X9HmKAiUetXBaz" +
                "QX2pVOhOKBETgEstVKB1CoN0fP98mbergW+THHxDpbtodep1EoWZePn/Qe/jly7" +
                "joL8HZuVAwzunmBsrrm0B1cRF3mG4/XZDdHqbz1humoz/8V8KMBuC899XhN1yZv" +
        ...
        const
        val RSA_PUBLIC_KEY_4096: String = ("-----BEGIN PUBLIC KEY-----\n" +
        ...
        const val PRIVATE_KEY_4096: String = ("-----BEGIN RSA PRIVATE KEY----- fake\n" +
        ...
        const val TEST_CA: String = ("-----BEGIN CERTIFICATE-----\n" +
        ...
        const val TEST_TRUSTED_CA: String = "-----BEGIN CERTIFICATE-----\n" +
        ...
        const val TEST_CERTIFICATE: String = ("-----BEGIN CERTIFICATE-----\n" +
        ...
        const val TEST_PRIVATE_KEY: String = ("-----BEGIN RSA PRIVATE KEY-----\n" +
        ...
        const val TEST_PRIVATE_KEY_PKCS8: String = ("-----BEGIN PRIVATE KEY-----\n" +
        ...
        const val TEST_PRIVATE_KEY_EC: String = "-----BEGIN EC PRIVATE KEY----- fake\n" +
        ...
        const val ENCRYPTED_TEST_PRIVATE_KEY_PKCS8: String = ("-----BEGIN ENCRYPTED PRIVATE KEY-----\n" +
        ...
        const val OTHER_TEST_CERTIFICATE: String = "-----BEGIN CERTIFICATE----- fake\n" +
        ...
        const val OTHER_TEST_PRIVATE_KEY: String = "-----BEGIN RSA PRIVATE KEY----- fake\n" +
        ...
        const val OTHER_TEST_PRIVATE_KEY_PKCS8: String = "-----BEGIN PRIVATE KEY----- fake\n" +
        ...
        const val TEST_INTERMEDIATE_CA: String = ("-----BEGIN CERTIFICATE-----\n" +
        ...
        const val TEST_INTERMEDIATE_CA_PRIVATE_KEY: String = ("-----BEGIN RSA PRIVATE KEY-----\n" +
        ...
        const val TEST_CA_WITH_DIFFERENT_SKID: String = "-----BEGIN CERTIFICATE-----\n" +
        ...
        const val TEST_KEY_WITH_DIFFERENT_SKID: String = "-----BEGIN RSA PRIVATE KEY-----\n" +
