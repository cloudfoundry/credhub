...
class PermissionDataService
    ...
    constructor(
        ...
        fun getPermissions(credential: Credential): MutableList<PermissionEntry> = createViewsFromPermissionsFor(credential)
        ...
        fun hasPermission(
            user: String,
            path: String,
            requiredPermission: PermissionOperation,
        ): Boolean {
        ...
        private fun createViewsFromPermissionsFor(credential: Credential): MutableList<PermissionEntry> {
            ...
            return data
                .stream()
                .map<PermissionEntry> { this.createViewFor(it) }
                .toList()
                .toMutableList()
        }
        ...
        fun permissionExists(
            user: String,
            path: String,
        ): Boolean = permissionRepository.findByPathAndActor(path, user) != null
        ...
        fun findByPathAndActor(
            path: String,
            actor: String,
        ): PermissionData? = permissionRepository.findByPathAndActor(path, actor)
    }
