...
class DefaultPermissionService
    ...
    constructor(
        ...
        override fun getAllowedOperationsForLogging(
            ...
            actor: String,
        ): List<PermissionOperation> = permissionDataService.getAllowedOperations(credentialName, actor)
        ...
        private fun checkActorPermissions(
            permissionUUID: UUID,
            actor: String?,
        ) {
        ...
        private fun getPermissions(credential: Credential): MutableList<PermissionEntry> = permissionDataService.getPermissions(credential)
    }
