                    ...
                    document(
                        ...
                        requestFields(
                            ...
                            fieldWithPath("duration")
                                .description(
                                    "Set the duration for the regenerated certificate. If not provided, the duration will be the same as the original certificate. If smaller than minimum duration then minimum duration is taken.",
                                ).type(JsonFieldType.NUMBER)
                                .optional(),
                ...
                .andDo(
                    document(
                        ...
                        requestFields(
                            ...
                            fieldWithPath("duration")
                                .description(
                                    "Set the duration for the regenerated certificate. If not provided, the duration will be the same as the original certificate. If smaller than minimum duration, minimum duration will get used",
                                ).type(JsonFieldType.NUMBER)
                                .optional(),
                            fieldWithPath("metadata")
                                .description("Additional metadata of the credential.")
